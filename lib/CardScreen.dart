            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "2 Pysical Cards and 1 Virtual Card",
                              style: TextStyle(
                                  fontWeight: FontWeight.w900,
                                  fontSize: 14,
                                  color: Colors.black),
                        ...
                        IconButton(
                            icon: Icon(Icons.more_horiz,color: Colors.lightBlue[900],
                              size: 30,
                  ...
                  Container(
                    child: Text("Card Settings", style: TextStyle(
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text("Card Settings",style: TextStyle(
                              fontWeight: FontWeight.w500,
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text("ATM Withdrawal",style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 18,color: Colors.grey[700]
                            ),),
                            SizedBox(
